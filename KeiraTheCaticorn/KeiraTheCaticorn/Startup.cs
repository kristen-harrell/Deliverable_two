...
namespace KeiraTheCaticorn
{
    public class Startup
    {
        ...
        {
            services.AddHttpClient<ArtDAL>(client =>
            {
                client.BaseAddress = new Uri("https://www.deviantart.com/api/v1/oauth2/gallery/all");
            });
